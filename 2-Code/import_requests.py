...
=======
def telecharger_toutes_factures():
    ...
    base_url = "https://projetocrstorageacc.blob.core.windows.net"
    # Paramètres SAS pour la liste et le téléchargement
    listing_params = ("?restype=container&comp=list&sv=2019-12-12&ss=b&srt=sco&sp=rl&"
                      "se=2026-01-01T00:00:00Z&st=2025-01-01T00:00:00Z&spr=https&"
                      "sig=%2BjCi7n8g%2F3849Rprey27XzHMoZN9zdVfDw6CifS6Y1U%3D")
    download_params = ("sv=2019-12-12&ss=b&srt=sco&sp=rl&"
                       "se=2026-01-01T00:00:00Z&st=2025-01-01T00:00:00Z&spr=https&"
                       "sig=%2BjCi7n8g%2F3849Rprey27XzHMoZN9zdVfDw6CifS6Y1U%3D")
    
    # Détermination de la période d'années à partir de 2018 jusqu'à l'année en cours
    annee_debut = 2018
    annee_fin = datetime.datetime.now().year + 1  # inclut l'année en cours
    for annee in range(annee_debut, annee_fin):
        container = f"invoices-{annee}"
>>>>>>> 4ab907e54452c83ad345e290d83906a555d0cc91
...
=======
                # Pour éviter toute collision, on préfixe le nom du container au nom du fichier
                destination_file = os.path.join(destination_dir, f"{container}_{blob_name}")
>>>>>>> 4ab907e54452c83ad345e290d83906a555d0cc91
